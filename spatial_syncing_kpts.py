    ...
    for session in sessions:
        ...
        for camera in cameras:
            ...
            for movement in movements:
                ...
                # add couple more markers, ankle knee shoulders

                avg_x_offset = (offset_x_asis + offset_x_psis) / 2
                avg_y_offset = (offset_y_asis + offset_y_psis) / 2
                avg_z_offset = (offset_z_asis + offset_z_psis) / 2
